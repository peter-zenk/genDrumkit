...
class Exporter_Drumgizmo(Exporter_Base):
    ...
    def _export_midi_file(self):
        ...
        logger.info("Midi XML created: '%s'", self._midi_fn)
    ...
    def _export_drum_kit_file(self):
        ...
        logger.info("Drum kit XML created: '%s'", self._kit_fn)
    ...
    def _export_instr_file(self, instrument):
        ...
        logger.debug("Instrument XML file created: '%s'", xml_fn)

    @staticmethod
    def _write_xml(tree, fname):
