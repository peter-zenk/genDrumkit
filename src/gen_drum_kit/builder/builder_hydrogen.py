...
class Builder_Hydrogen(Builder_Base):
    """ creates a drum kit from Hydrogen DB """
    ...
    def __init__(self, params, xml, mapDB):
        ...
        self._channel_list = None # assigned later
        self._groups       = None # assigned later
        self._root         = None # assigned later
    ...
    @staticmethod
    def _xml_extract_sample_info(layers):
        info = []
